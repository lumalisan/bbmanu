...
void LCDInit(){
    ...
    // End reset
    LCDWriteNibbleCmd(0x38);  // Set 8-bits interface
    waitLCD();
...
void LCDWriteCmd(char cmd){
    ...
    LCD_DB7_W = (unsigned int)((cmd & 0x80)>>7);
    LCD_DB6   = (unsigned int)((cmd & 0x40)>>6);
    LCD_DB5   = (unsigned int)((cmd & 0x20)>>5);
    LCD_DB4   = (unsigned int)((cmd & 0x10)>>4);
    LCD_DB3   = (unsigned int)((cmd & 0x08)>>3);
    LCD_DB2   = (unsigned int)((cmd & 0x04)>>2);
    LCD_DB1   = (unsigned int)((cmd & 0x02)>>1);
    LCD_DB0   = (unsigned int) (cmd & 0x01);
...
void LCDWriteData(char data){
    ...
    LCD_DB7_W = (unsigned int)((data & 0x80)>>7);
    LCD_DB6   = (unsigned int)((data & 0x40)>>6);
    LCD_DB5   = (unsigned int)((data & 0x20)>>5);
    LCD_DB4   = (unsigned int)((data & 0x10)>>4);
    LCD_DB3   = (unsigned int)((data & 0x08)>>3);
    LCD_DB2   = (unsigned int)((data & 0x04)>>2);
    LCD_DB1   = (unsigned int)((data & 0x02)>>1);
    LCD_DB0   = (unsigned int)((data & 0x01)>>0);
